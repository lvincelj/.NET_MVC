        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepartmentName = table.Column<string>(type: "TEXT", maxLength: 120, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HeadOfDepartment = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginalnoIme = table.Column<string>(type: "TEXT", maxLength: 260, nullable: false),
                    NazivNaDisku = table.Column<string>(type: "TEXT", maxLength: 260, nullable: false),
                    Putanja = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    ContentType = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    Velicina = table.Column<long>(type: "INTEGER", nullable: false),
                    DatumUtc = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
